...
public class PortfolioCourseUnitLevel {
	...
	public PortfolioCourseUnitLevel(int id, int service_portfolio_course_id,
			int level, int is_deleted, Timestamp created_at,
			Timestamp updated_at, int service_id, int sort_id, int course_id) {
		super();
		this.id = id;
	...
	public String toString() {
		return "PortfolioCourseUnitLevel [id=" + id
