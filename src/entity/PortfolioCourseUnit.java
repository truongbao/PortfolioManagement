...
public class PortfolioCourseUnit {
	...
	public PortfolioCourseUnit(int id, int portfolio_course_unit_level_id, int sort_id, int question_attribute_id,
			int is_deleted, Timestamp created_at, Timestamp updated_at, int service_portfolio_course_id, int level,
	...
	public String toString() {
		return "PortfolioCourseUnit [id=" + id + ", portfolio_course_unit_level_id=" + portfolio_course_unit_level_id
				+ ", sort_id=" + sort_id + ", question_attribute_id=" + question_attribute_id + ", is_deleted="
				+ is_deleted + ", created_at=" + created_at + ", updated_at=" + updated_at
				+ ", service_portfolio_course_id=" + service_portfolio_course_id + ", level=" + level
