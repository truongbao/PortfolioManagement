...
<div class="main-content" id="portfolio">
	...
	<div class="main-summary portfolio-unit">
		<form:form id="spc_insert_form" class="form-horizontal"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="spcf_name" type="text" name="spcf.name"
						class="form-control" value="${objSPCF.name}">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<table class="table table-blue table_portfolio_groups">
						<thead>
							<tr>
								<th class="group_secern_name">種別 (group_secern_name)</th>
								<th class="group_name">項目 (group_name)</th>
							</tr>
						</thead>
						<tbody>
			...
			<div class="form-group">
				<label class="control-label col-sm-2 label_align_left ">対象科目 (Name Course)</label>
					...
					<select id="SP_Course_Selected" multiple="multiple"
						...
						<c:forEach items="${spcwoutput.spcs}" var="objSPCourse">
							<option value="${objSPCourse.id}"
								<c:if test="${ objSPCourse.isSelected == 1}">selected="selected"</c:if>>  ${objSPCourse.course_name}
							</option>
						</c:forEach>
					</select>
				</div>
